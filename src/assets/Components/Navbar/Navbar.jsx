...
const Navbar = () => {
  return (
    <div className='container mt-4 text-center md:flex justify-around mx-auto'>
      <div>
        <h1 className='text-3xl font-bold text-black'>Recipe Calories</h1>
      </div>
      <div className=''>
        <ul className='md:flex justify-around gap-4'>
          <li>Home</li>
          <li>Recipes</li>
          <li>About</li>
          <li>Search</li>
      ...
      <div className='flex text-center justify-center md:flex gap-2 rounded-full'>
